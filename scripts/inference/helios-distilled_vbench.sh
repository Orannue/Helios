...
# Based on scripts/inference/helios-distilled_t2v.sh.
...
usage() {
  cat <<'USAGE'
Usage:
  bash scripts/inference/helios-distilled_vbench.sh [options]
...
Options:
  ...
  --num-frames N                Output video frames. Default: 240.
